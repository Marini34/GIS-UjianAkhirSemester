    ...
    <nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
        <div class="sidebar-inner px-4 pt-3">
            ...
            <ul class="nav flex-column pt-3 pt-md-0">
                ...
                <!--SIDEBAR MENU-->
                <li class="nav-item {{ Request::routeIs(['welcome', 'home', 'dashboard']) ? 'active' : '' }}">
                ...
                {{-- <li class="nav-item {{ Request::routeIs(['jarak']) ? 'active' : '' }}">
                    <a href="{{ route('dashboard') }}" class="nav-link d-flex align-items-center">
                        <span class="sidebar-icon">
                            <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="sidebar-text">Test Jarak</span>
                    </a>
                </li> --}}
                <li class="nav-item {{ Request::routeIs(['places.*']) ? 'active' : '' }}">
                    <a href="{{ route('places.index') }}" class="nav-link d-flex align-items-center">
                        <span class="sidebar-icon">
                            <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                        ...
                        <span class="sidebar-text">Kelola Spot</span>
                    </a>
                </li>
