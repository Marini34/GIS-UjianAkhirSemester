...
<!-- Primary Meta Tags -->
<title>Laravel & Leafletcss Volt - Sign in page</title>
...
<!-- Sweet Alert -->
<link type="text/css" href="{{ asset('volt/html&css/vendor/sweetalert2/dist/sweetalert2.min.css') }}" rel="stylesheet">
